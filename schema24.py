...
hdata = {'User-Agent':'Mozilla/5.0 (X11; Linux x86_64; rv:108.0) Gecko/20100101 Firefox/108.0',
    ...
    'Referer' : "https://web.skola24.se/timetable/timetable-viewer/molndal.skola24.se/Kroksl%C3%A4ttsgymnasiet/",
...
def get_week(week, larare_id, s):
    ...
    weekrequest = {
        ...
        'endDate': None,
        'height': 550,
        'host': "molndal.skola24.se",
        'periodText': "",
        'privateFreeTextMode': False,
        'privateSelectionMode': None,
        'renderKey': get_key(s),
        'scheduleDay': 0,
        'schoolYear':'4e6cb8ac-4bc4-4b9e-bac4-7ecdb25dd12d',
        'selection': larare_id,
        'selectionType': 4,
        'showHeader': False,
        'startDate': None,
        'unitGuid': "YjkzN2M0MWUtZWVlOC1mNTQxLWJhMWQtNmM2ZjdhYmZkZTU3",
        'week': week,
        'width': 1200,
        'year': year
        }  
